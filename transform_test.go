...
func TestTransformExternalLink(t *testing.T) {
	cases := []struct {
		...
		{name: "obsidian url", root: "testdata/transformexternallink/obsidianurl", raw: []rune("[open obsidian note](obsidian://open?vault=obsidian&file=test)"), want: []rune("[open obsidian note](test.md)")},
		{name: "escaped japanese obsidian url", root: "testdata/transformexternallink/escaped_obsidianurl", raw: []rune("[日本語のテスト](obsidian://open?vault=obsidian&file=%E3%83%86%E3%82%B9%E3%83%88)"), want: []rune("[日本語のテスト](テスト.md)")},
	}
